 ...
 * - Cross-entity reference creation (membership-employment, membership-category, etc.)
 *
 * BUSINESS LOGIC:
 * - Converts business IDs (osot-0000210) to Dataverse GUIDs
...
export class UserGuidResolverUtil {
   ...
   *
   * @param businessId - Business ID (e.g., "osot-0000210")
