/**
 * Basic Audience Target DTO
 * Complete version with all fields including system-generated ones
 *
 * ESSENTIAL MODULES INTEGRATION:
 * - Base DTO used by Create/Update operations
 * - Includes complete business rule validation for all 35 multiple choice fields
 * - Integrates with DataverseService for full entity management
 * - Contains both user-provided and system-generated fields
 *
 * DATAVERSE INTEGRATION:
 * - Target ID format: osot-tgt-0000001 (auto-generated)
 * - UUID primary key (osot_table_audience_targetid)
 * - System timestamps (createdon, modifiedon)
 * - One lookup relationship to Product with @odata.bind pattern
 * - Complete OData entity representation
 *
 * USAGE CONTEXT:
 * - Extended by Create/Update DTOs for operations
 ...
 * - Product lookup is REQUIRED (enforced in Create DTO)
 * - One target per product (enforced by repository)
 * - System fields are read-only
 * - Target ID must follow osot-tgt-NNNNNNN format
 * - Table must be "osot_table_audience_target"
...
/**
 * Audience Target Basic DTO
 * Contains all fields for complete audience target entity management
 */
export class AudienceTargetBasicDto {
  // ========================================
  // SYSTEM FIELDS (Read-only, Auto-generated)
  // ========================================

  @ApiProperty({
    example: 'a1b2c3d4-e5f6-7890-abcd-123456789012',
    description: 'Primary key (GUID) - Auto-generated by Dataverse (read-only)',
    required: false,
  })
  @IsOptional()
  @IsUUID()
  ...
  @ApiProperty({
    ...
    description: 'Business ID - Auto-generated autonumber (read-only)',
    required: false,
  })
  @IsOptional()
  @IsString()
  ...
  @ApiProperty({
    example: 'd4c3b2a1-f6e5-0987-dcba-987654321012',
    description: 'Owner ID (GUID) - System managed (read-only)',
    required: false,
  })
  @IsOptional()
  @IsUUID()
  ...
  @ApiProperty({
    ...
    description: 'Creation timestamp - System managed (read-only)',
    required: false,
  })
  @IsOptional()
  @IsString()
  ...
  @ApiProperty({
    ...
    description: 'Last modification timestamp - System managed (read-only)',
    required: false,
  })
  @IsOptional()
  @IsString()
  ...
  @ApiProperty({
    ...
    description:
      'Product lookup (GUID) - Business required for creation, one target per product',
    required: false,
  })
  @IsOptional()
  @IsUUID()
  ...
  @ApiProperty({
    ...
    description: 'OData bind format for product relationship',
    required: false,
  })
  @IsOptional()
  @Allow()
